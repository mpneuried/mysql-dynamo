  ...
  module.exports = MySQLDynamoTable = (function(_super) {
    ...
    function MySQLDynamoTable(_model_settings, options) {
      ...
      this.getter("tableName", (function(_this) {
        return function() {
          return (options.tablePrefix || "") + (_this._model_settings.combineTableTo != null ? _this._model_settings.combineTableTo + "_" : "") + _this._model_settings.name;
        };
      })(this));
      this.getter("existend", (function(_this) {
        return function() {
          return _this.external != null;
        };
      })(this));
      this.getter("hasRange", (function(_this) {
        return function() {
          var _ref, _ref1;
      ...
      this.getter("rangeKeyLength", (function(_this) {
        return function() {
          var _ref;
    ...
    MySQLDynamoTable.prototype.get = function() {
      ...
      if (this._isExistend(cb)) {
        ...
        sql.filter(_query);
        this.sql(sql.select(false), (function(_this) {
    ...
    MySQLDynamoTable.prototype.mget = function() {
      ...
      if (this._isExistend(cb)) {
        ...
        this.sql(_statement, (function(_this) {
          return function(err, results) {
    ...
    MySQLDynamoTable.prototype.set = function() {
      ...
      if (this._isExistend(cb)) {
        ...
        this._validateAttributes(_create, attributes, (function(_this) {
          return function(err, attributes) {
            var statements, _query, _select, _update;
            if (err) {
              cb(err);
              return;
            }
    ...
    MySQLDynamoTable.prototype.del = function(_id, cb) {
      ...
      if (this._isExistend(cb)) {
        ...
        this.sql(_statements, (function(_this) {
          return function(err, results) {
            ...
            _deleted = results[0], _meta = results[1];
    ...
    MySQLDynamoTable.prototype.destroy = function(cb) {
      ...
      if (this._isExistend()) {
        sql = this.builder.clone();
        this.sql(sql.drop(), (function(_this) {
    ...
    MySQLDynamoTable.prototype._generate = function(cb) {
      ...
      this.sql(statement, (function(_this) {
